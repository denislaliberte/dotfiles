...
if ($argc === 1) {
	die(
		...
		"./srdbcli.php -h localhost -u DBUSER -p DBPASS -n DBNAME -s \"findMe\" -r \"replaceBy\"\n".
		"\n".
		"Use the --dry-run flag to do a dry run without searching/replacing.\n".
		"\n".
		"For more info, type: ./srdbcli.php --help\n".
		"\n"
	);
}
